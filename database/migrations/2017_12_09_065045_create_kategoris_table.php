...
class CreateKategorisTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Kategoris", 'kategoris', 'nama_kategori', 'fa-tags', [
            ["nama_kategori", "Nama Kategori", "String", false, "", 0, 256, true],
            ["mark_up", "Mark Up", "Currency", false, "", 1, 100, false],
        ]);
