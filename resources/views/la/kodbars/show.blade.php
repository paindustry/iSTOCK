...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $kodbar->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Kodbars", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/kodbars/'.$kodbar->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Kodbars", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.kodbars.destroy', $kodbar->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/kodbars') }}" data-toggle="tooltip" data-placement="right" title="Back to Kodbars"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'tanggal_masuk')
						@la_display($module, 'harga_beli')
						@la_display($module, 'harga_jual')
						@la_display($module, 'kategori_barang')
					</div>
				</div>
			</div>
		</div>
