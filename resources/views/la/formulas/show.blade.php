...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $formula->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Formulas", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/formulas/'.$formula->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Formulas", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.formulas.destroy', $formula->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/formulas') }}" data-toggle="tooltip" data-placement="right" title="Back to Formulas"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'single_ex')
						@la_display($module, 'double_ex')
						@la_display($module, 'at')
						@la_display($module, 'bt')
						@la_display($module, 'rekomendasi')
					</div>
				</div>
			</div>
		</div>
