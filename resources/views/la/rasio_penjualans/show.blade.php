...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $rasio_penjualan->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Rasio_penjualans", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/rasio_penjualans/'.$rasio_penjualan->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Rasio_penjualans", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.rasio_penjualans.destroy', $rasio_penjualan->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/rasio_penjualans') }}" data-toggle="tooltip" data-placement="right" title="Back to Rasio penjualans"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'bulan_ke')
						@la_display($module, 'kode_barang')
						@la_display($module, 'jumlah_penjualan')
					</div>
				</div>
			</div>
		</div>
