...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $koddiv->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Koddivs", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/koddivs/'.$koddiv->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Koddivs", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.koddivs.destroy', $koddiv->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/koddivs') }}" data-toggle="tooltip" data-placement="right" title="Back to Koddivs"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'kode_divisi')
						@la_display($module, 'nama_divisi')
					</div>
				</div>
			</div>
		</div>
