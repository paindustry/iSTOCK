...
class StocksController extends Controller
{
	...
	public $listing_cols = ['id', 'kode_barang', 'jumlah_barang', 'harga_total', 'kategori'];
	...
	public function store(Request $request)
	{
		if(Module::hasAccess("Stocks", "create")) {
			...
			$result = mysqli_query($mysqli, "UPDATE stocks as a, kodbars as b SET a.harga_total=a.jumlah_barang*b.harga_jual WHERE a.id='$insert_id'");
