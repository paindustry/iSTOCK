...
Route::group(['as' => $as, 'middleware' => ['auth', 'permission:ADMIN_PANEL']], function () {
	...
	/* ================== Kodbars ================== */
	Route::resource(config('laraadmin.adminRoute') . '/kodbars', 'LA\KodbarsController');
	Route::get(config('laraadmin.adminRoute') . '/kodbar_dt_ajax', 'LA\KodbarsController@dtajax');
